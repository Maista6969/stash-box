	...
	for _, key := range []models.ImageTypeEnum{
		...
		t.Run(string(key), func(t *testing.T) {
			...
			for i, guide := range template.Guides {
				...
				// A line outside the canvas would render outside the crop frame where it means nothing
...
// and a pose or a state of dress has nothing to say about the shape of the picture
