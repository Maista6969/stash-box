...
type ImageRevertCategorizationInput struct {
	ID uuid.UUID `json:"id"`
}

type ImageSetOrganizedInput struct {
	ID        uuid.UUID `json:"id"`
...
type UnorganizedImagesQueryInput struct {
	Page        int        `json:"page"`
	PerPage     int        `json:"per_page"`
